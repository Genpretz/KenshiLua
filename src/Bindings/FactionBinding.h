...
public:
    ...
    static int getActivePlatoons(lua_State* L);
    static int getUnloadedPlatoons(lua_State* L);
    ...
    static int getSquadThatOwns(lua_State* L);
    static int getAllSquadsThatOwn(lua_State* L);
    static int getAllActiveSquads(lua_State* L);

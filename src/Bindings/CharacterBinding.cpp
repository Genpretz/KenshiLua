...
void CharacterBinding::registerBinding(lua_State* L)
{
    ...
    registerGetter(L, "offscreenFrameTime", Character_get_offscreenFrameTime);
    registerGetter(L, "frameTIME", Character_get_frameTIME);
    registerGetter(L, "frameTIMEfour", Character_get_frameTIMEfour);
    registerGetter(L, "frameTIME_P", Character_get_frameTIME_P);
    registerGetter(L, "bodyDecayTimer", Character_get_bodyDecayTimer);
    registerGetter(L, "stealthMode", Character_get_stealthMode);
    registerGetter(L, "_isOnARoof", Character_get__isOnARoof);
    registerGetter(L, "_lightLevel", Character_get__lightLevel);
    registerGetter(L, "needsLightLevel", Character_get_needsLightLevel);
    registerGetter(L, "_currentProneState", Character_get__currentProneState);
    registerGetter(L, "isVisibleUpdateMode", Character_get_isVisibleUpdateMode);
    registerGetter(L, "setVisibleMsg", Character_get_setVisibleMsg);
    registerGetter(L, "stealthUnseen", Character_get_stealthUnseen);
    registerGetter(L, "playerWantsMeToGetUp", Character_get_playerWantsMeToGetUp);
    registerGetter(L, "crimes", Character_get_crimes);
    registerGetter(L, "currentSkillUsing", Character_get_currentSkillUsing);
    registerGetter(L, "stateBroadcast", Character_get_stateBroadcast);
    registerGetter(L, "isVisibleAndNear", Character_get_isVisibleAndNear);
    registerGetter(L, "isOnScreen", Character_get_isOnScreen);
    registerGetter(L, "stealthMarkerArrows", Character_get_stealthMarkerArrows);
    registerGetter(L, "_isEngagedWithAPlayer", Character_get__isEngagedWithAPlayer);
    registerGetter(L, "isUsingTurret", Character_get_isUsingTurret);
    registerGetter(L, "isCurrentlyGettingUp", Character_get_isCurrentlyGettingUp);
    registerGetter(L, "isGettingEaten", Character_get_isGettingEaten);
    registerGetter(L, "dialogue", Character_get_dialogue);
    registerGetter(L, "currentStumblePainAnimation", Character_get_currentStumblePainAnimation);
    registerGetter(L, "_isLiterallyUnderMeleeAttackRightNowForSure", Character_get__isLiterallyUnderMeleeAttackRightNowForSure);
    registerGetter(L, "_myMemory", Character_get__myMemory);
    registerGetter(L, "lastGuyWhoDefeatedMe", Character_get_lastGuyWhoDefeatedMe);
    registerGetter(L, "myRace", Character_get_myRace);
    registerGetter(L, "inventory", Character_get_inventory);
    registerGetter(L, "rangedCombat", Character_get_rangedCombat);
    registerGetter(L, "inWhat", Character_get_inWhat);
    registerGetter(L, "isChained", Character_get_isChained);
    registerGetter(L, "slaveOwner", Character_get_slaveOwner);
    registerGetter(L, "isCarryingSomething", Character_get_isCarryingSomething);
    registerGetter(L, "carringObjectLeftOrRight", Character_get_carringObjectLeftOrRight);
    registerGetter(L, "isCarryingLeftSide", Character_get_isCarryingLeftSide);
    registerGetter(L, "carryingObject", Character_get_carryingObject);
    registerGetter(L, "messages", Character_get_messages);
    registerGetter(L, "messageSubject", Character_get_messageSubject);
    registerGetter(L, "ragdollNavmeshPosition", Character_get_ragdollNavmeshPosition);
    registerGetter(L, "_isBeingCarried", Character_get__isBeingCarried);
    registerGetter(L, "lastUsedWeaponCategory", Character_get_lastUsedWeaponCategory);
    registerGetter(L, "msgCarryMode", Character_get_msgCarryMode);
    registerGetter(L, "squadMemberID", Character_get_squadMemberID);
    registerGetter(L, "diplomacyMultiplier", Character_get_diplomacyMultiplier);
    registerGetter(L, "_destinationInsideBuilding", Character_get__destinationInsideBuilding);
    registerGetter(L, "_destinationInsideWalls", Character_get__destinationInsideWalls);
    registerGetter(L, "animation", Character_get_animation);
    registerGetter(L, "stats", Character_get_stats);
    registerGetter(L, "medical", Character_get_medical);
    registerGetter(L, "isPhysicalMode", Character_get_isPhysicalMode);
    registerGetter(L, "sex", Character_get_sex);
    registerGetter(L, "nameTag", Character_get_nameTag);
    registerGetter(L, "movement", Character_get_movement);
    registerGetter(L, "body", Character_get_body);
    registerGetter(L, "ai", Character_get_ai);
    registerGetter(L, "platoon", Character_get_platoon);
    registerGetter(L, "portraitIndex", Character_get_portraitIndex);
    registerGetter(L, "portraitSerial", Character_get_portraitSerial);
    registerGetter(L, "groundType", Character_get_groundType);
    registerGetter(L, "armourType", Character_get_armourType);
    registerGetter(L, "audioEmitter", Character_get_audioEmitter);
    registerGetter(L, "terrainHeightPosition", Character_get_terrainHeightPosition);
    registerGetter(L, "inDoorsSetCooldown", Character_get_inDoorsSetCooldown);
    registerGetter(L, "naturalWeapon", Character_get_naturalWeapon);
    registerGetter(L, "audioData", Character_get_audioData);
    registerGetter(L, "ragdollMessages", Character_get_ragdollMessages);
    registerGetter(L, "disguiseGUIFeedbacks", Character_get_disguiseGUIFeedbacks);
    registerGetter(L, "whoSeesMeSneaking", Character_get_whoSeesMeSneaking);
    registerGetter(L, "inSomething", Character_get_inSomething);
    registerGetter(L, "audioObject", Character_get_audioObject);
    registerGetter(L, "activeEffects", Character_get_activeEffects);
    lua_setfield(L, -2, "__getters"); // Bind to metatable

    lua_newtable(L); // Create __setters table
    registerSetter(L, "offscreenFrameTime", Character_set_offscreenFrameTime);
    registerSetter(L, "frameTIME", Character_set_frameTIME);
    registerSetter(L, "frameTIMEfour", Character_set_frameTIMEfour);
    registerSetter(L, "frameTIME_P", Character_set_frameTIME_P);
    registerSetter(L, "bodyDecayTimer", Character_set_bodyDecayTimer);
    registerSetter(L, "stealthMode", Character_set_stealthMode);
    registerSetter(L, "_isOnARoof", Character_set__isOnARoof);
    registerSetter(L, "_lightLevel", Character_set__lightLevel);
    registerSetter(L, "needsLightLevel", Character_set_needsLightLevel);
    registerSetter(L, "_currentProneState", Character_set__currentProneState);
    registerSetter(L, "isVisibleUpdateMode", Character_set_isVisibleUpdateMode);
    registerSetter(L, "setVisibleMsg", Character_set_setVisibleMsg);
    registerSetter(L, "stealthUnseen", Character_set_stealthUnseen);
    registerSetter(L, "playerWantsMeToGetUp", Character_set_playerWantsMeToGetUp);
    registerSetter(L, "crimes", Character_set_crimes);
    registerSetter(L, "currentSkillUsing", Character_set_currentSkillUsing);
    registerSetter(L, "isVisibleAndNear", Character_set_isVisibleAndNear);
    registerSetter(L, "isOnScreen", Character_set_isOnScreen);
    registerSetter(L, "stealthMarkerArrows", Character_set_stealthMarkerArrows);
    registerSetter(L, "_isEngagedWithAPlayer", Character_set__isEngagedWithAPlayer);
    registerSetter(L, "isUsingTurret", Character_set_isUsingTurret);
    registerSetter(L, "isCurrentlyGettingUp", Character_set_isCurrentlyGettingUp);
    registerSetter(L, "isGettingEaten", Character_set_isGettingEaten);
    registerSetter(L, "dialogue", Character_set_dialogue);
    registerSetter(L, "currentStumblePainAnimation", Character_set_currentStumblePainAnimation);
    registerSetter(L, "_isLiterallyUnderMeleeAttackRightNowForSure", Character_set__isLiterallyUnderMeleeAttackRightNowForSure);
    registerSetter(L, "lastGuyWhoDefeatedMe", Character_set_lastGuyWhoDefeatedMe);
    registerSetter(L, "myRace", Character_set_myRace);
    registerSetter(L, "inventory", Character_set_inventory);
    registerSetter(L, "inWhat", Character_set_inWhat);
    registerSetter(L, "isChained", Character_set_isChained);
    registerSetter(L, "slaveOwner", Character_set_slaveOwner);
    registerSetter(L, "isCarryingSomething", Character_set_isCarryingSomething);
    registerSetter(L, "carringObjectLeftOrRight", Character_set_carringObjectLeftOrRight);
    registerSetter(L, "isCarryingLeftSide", Character_set_isCarryingLeftSide);
    registerSetter(L, "carryingObject", Character_set_carryingObject);
    registerSetter(L, "messages", Character_set_messages);
    registerSetter(L, "messageSubject", Character_set_messageSubject);
    registerSetter(L, "ragdollNavmeshPosition", Character_set_ragdollNavmeshPosition);
    registerSetter(L, "_isBeingCarried", Character_set__isBeingCarried);
    registerSetter(L, "lastUsedWeaponCategory", Character_set_lastUsedWeaponCategory);
    registerSetter(L, "squadMemberID", Character_set_squadMemberID);
    registerSetter(L, "diplomacyMultiplier", Character_set_diplomacyMultiplier);
    registerSetter(L, "_destinationInsideBuilding", Character_set__destinationInsideBuilding);
    registerSetter(L, "_destinationInsideWalls", Character_set__destinationInsideWalls);
    registerSetter(L, "stats", Character_set_stats);
    registerSetter(L, "medical", Character_set_medical);
    registerSetter(L, "isPhysicalMode", Character_set_isPhysicalMode);
    registerSetter(L, "sex", Character_set_sex);
    registerSetter(L, "movement", Character_set_movement);
    registerSetter(L, "body", Character_set_body);
    registerSetter(L, "platoon", Character_set_platoon);
    registerSetter(L, "portraitIndex", Character_set_portraitIndex);
    registerSetter(L, "portraitSerial", Character_set_portraitSerial);
    registerSetter(L, "groundType", Character_set_groundType);
    registerSetter(L, "armourType", Character_set_armourType);
    registerSetter(L, "terrainHeightPosition", Character_set_terrainHeightPosition);
    registerSetter(L, "inDoorsSetCooldown", Character_set_inDoorsSetCooldown);
    registerSetter(L, "naturalWeapon", Character_set_naturalWeapon);
    registerSetter(L, "stateBroadcast", Character_set_stateBroadcast);
    registerSetter(L, "_myMemory", Character_set__myMemory);
    registerSetter(L, "rangedCombat", Character_set_rangedCombat);
    registerSetter(L, "inSomething", Character_set_inSomething);
    registerSetter(L, "msgCarryMode", Character_set_msgCarryMode);
    registerSetter(L, "animation", Character_set_animation);
    registerSetter(L, "nameTag", Character_set_nameTag);
    registerSetter(L, "ai", Character_set_ai);
    registerSetter(L, "audioData", Character_set_audioData);
    registerSetter(L, "audioObject", Character_set_audioObject);
    registerSetter(L, "audioEmitter", Character_set_audioEmitter);
    registerSetter(L, "ragdollMessages", Character_set_ragdollMessages);

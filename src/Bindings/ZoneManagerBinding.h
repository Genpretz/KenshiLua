...
public:
    ...
    static int findShop(lua_State* L);
    static int findAnyShop(lua_State* L);
    ...
    static int getZoneMapFromResolutionCoord(lua_State* L);
    static int playerActivate(lua_State* L);
    static int deactivateZoneMap(lua_State* L);
    ...
    static int addGroundEffect(lua_State* L);
    ...
    static int checkForRepopulateTown(lua_State* L);

...
public:
    ...
    static int chooseNewHome(lua_State* L);
    ...
    static int hasCampaign(lua_State* L);
    static int iBuyStolenGoods(lua_State* L);
    static int iBuyIllegalGoods(lua_State* L);
    static int setFaction(lua_State* L);
    static int _NV_setFaction(lua_State* L);
    static int canTakeRefugees(lua_State* L);
    static int isUnique(lua_State* L);
    static int _NV_isUnique(lua_State* L);
    ...
    static int serialiseEverything(lua_State* L);
    static int _NV_serialiseEverything(lua_State* L);
    static int loadStateData(lua_State* L);
    static int _NV_loadStateData(lua_State* L);
    static int loadFromSerialise(lua_State* L);
    static int _NV_loadFromSerialise(lua_State* L);
    static int reprocessTask(lua_State* L);
    static int taskIsComplete(lua_State* L);
    ...
    static int getUnloadedPlatoon(lua_State* L);
    ...
    static int getPatrolInfo(lua_State* L);
    static int getRoamingMapArea(lua_State* L);

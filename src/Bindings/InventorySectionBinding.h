...
public:
    ...
    static int setupContainerData(lua_State* L);
    ...
    static int addVeryLimitedSlot(lua_State* L);
    ...
    static int setupEquipCallbacks(lua_State* L);
    static int numItemsInFootprint(lua_State* L);

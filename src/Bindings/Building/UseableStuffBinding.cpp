...
void UseableStuffBinding::registerBinding(lua_State* L)
{
    ...
    registerGetter(L, "shopOwner", UseableStuff_get_shopOwner);
    registerGetter(L, "callbackOwner", UseableStuff_get_callbackOwner);
    registerGetter(L, "hasProgressBarWhenUsed", UseableStuff_get_hasProgressBarWhenUsed);
    registerGetter(L, "progressBarLevel", UseableStuff_get_progressBarLevel);
    registerGetter(L, "occupantSelection", UseableStuff_get_occupantSelection);
    registerGetter(L, "needsOperating", UseableStuff_get_needsOperating);
    registerGetter(L, "numOperatorsMax", UseableStuff_get_numOperatorsMax);
    registerGetter(L, "hungerRate", UseableStuff_get_hungerRate);
    registerGetter(L, "_recievesBatteryPower", UseableStuff_get__recievesBatteryPower);
    registerGetter(L, "powerOn", UseableStuff_get_powerOn);
    registerGetter(L, "_isBroken", UseableStuff_get__isBroken);
    registerGetter(L, "batteryOutputStat", UseableStuff_get_batteryOutputStat);
    registerGetter(L, "_powerOutputMax", UseableStuff_get__powerOutputMax);
    registerGetter(L, "currentPower", UseableStuff_get_currentPower);
    registerGetter(L, "powerTimeStored", UseableStuff_get_powerTimeStored);
    registerGetter(L, "_powerTimeStoreMax", UseableStuff_get__powerTimeStoreMax);
    registerGetter(L, "currentOperators", UseableStuff_get_currentOperators);
    registerGetter(L, "usesStat", UseableStuff_get_usesStat);
    registerGetter(L, "functionalityData", UseableStuff_get_functionalityData);
    registerGetter(L, "animation", UseableStuff_get_animation);
    registerGetter(L, "animationKO", UseableStuff_get_animationKO);
    registerGetter(L, "animationDazed", UseableStuff_get_animationDazed);
    registerGetter(L, "maxUseRange", UseableStuff_get_maxUseRange);
    registerGetter(L, "sfxTime", UseableStuff_get_sfxTime);
    registerGetter(L, "inventory", UseableStuff_get_inventory);
    registerGetter(L, "doorLock", UseableStuff_get_doorLock);
    lua_setfield(L, -2, "__getters"); // Bind to metatable

    lua_newtable(L); // Create __setters table
    registerSetter(L, "shopOwner", UseableStuff_set_shopOwner);
    registerSetter(L, "callbackOwner", UseableStuff_set_callbackOwner);
    registerSetter(L, "hasProgressBarWhenUsed", UseableStuff_set_hasProgressBarWhenUsed);
    registerSetter(L, "progressBarLevel", UseableStuff_set_progressBarLevel);
    registerSetter(L, "occupantSelection", UseableStuff_set_occupantSelection);
    registerSetter(L, "needsOperating", UseableStuff_set_needsOperating);
    registerSetter(L, "numOperatorsMax", UseableStuff_set_numOperatorsMax);
    registerSetter(L, "hungerRate", UseableStuff_set_hungerRate);
    registerSetter(L, "_recievesBatteryPower", UseableStuff_set__recievesBatteryPower);
    registerSetter(L, "powerOn", UseableStuff_set_powerOn);
    registerSetter(L, "_isBroken", UseableStuff_set__isBroken);
    registerSetter(L, "batteryOutputStat", UseableStuff_set_batteryOutputStat);
    registerSetter(L, "_powerOutputMax", UseableStuff_set__powerOutputMax);
    registerSetter(L, "currentPower", UseableStuff_set_currentPower);
    registerSetter(L, "powerTimeStored", UseableStuff_set_powerTimeStored);
    registerSetter(L, "_powerTimeStoreMax", UseableStuff_set__powerTimeStoreMax);
    registerSetter(L, "currentOperators", UseableStuff_set_currentOperators);
    registerSetter(L, "usesStat", UseableStuff_set_usesStat);
    registerSetter(L, "functionalityData", UseableStuff_set_functionalityData);
    registerSetter(L, "animation", UseableStuff_set_animation);
    registerSetter(L, "animationKO", UseableStuff_set_animationKO);
    registerSetter(L, "animationDazed", UseableStuff_set_animationDazed);
    registerSetter(L, "maxUseRange", UseableStuff_set_maxUseRange);
    registerSetter(L, "sfxTime", UseableStuff_set_sfxTime);
    registerSetter(L, "inventory", UseableStuff_set_inventory);
    registerSetter(L, "doorLock", UseableStuff_set_doorLock);

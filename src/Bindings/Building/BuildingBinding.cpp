...
void BuildingBinding::registerBinding(lua_State* L)
{
    ...
    registerGetter(L, "doors", Building_get_doors);
    registerGetter(L, "isFoliage", Building_get_isFoliage);
    registerGetter(L, "hasTerrainInside", Building_get_hasTerrainInside);
    registerGetter(L, "isCavernous", Building_get_isCavernous);
    registerGetter(L, "enforceCeiling", Building_get_enforceCeiling);
    registerGetter(L, "designation", Building_get_designation);
    registerGetter(L, "publicDaytime", Building_get_publicDaytime);
    registerGetter(L, "residentSquad", Building_get_residentSquad);
    registerGetter(L, "residentSquadTemplate", Building_get_residentSquadTemplate);
    registerGetter(L, "isAnInteriorObject", Building_get_isAnInteriorObject);
    registerGetter(L, "instanceID", Building_get_instanceID);
    registerGetter(L, "layoutInstanceID", Building_get_layoutInstanceID);
    registerGetter(L, "specialFunction", Building_get_specialFunction);
    registerGetter(L, "_buildState", Building_get__buildState);
    registerGetter(L, "classType", Building_get_classType);
    registerGetter(L, "updateNavmesh", Building_get_updateNavmesh);
    registerGetter(L, "visible", Building_get_visible);
    registerGetter(L, "interiorVisibility", Building_get_interiorVisibility);
    registerGetter(L, "justBeenUpgradedFlag", Building_get_justBeenUpgradedFlag);
    registerGetter(L, "imADoor", Building_get_imADoor);
    registerGetter(L, "destroyed", Building_get_destroyed);
    registerGetter(L, "productionMult", Building_get_productionMult);
    registerGetter(L, "productionMult_baseData", Building_get_productionMult_baseData);
    registerGetter(L, "hasMovingParts", Building_get_hasMovingParts);
    registerGetter(L, "saveVersion", Building_get_saveVersion);
    registerGetter(L, "_town", Building_get__town);
    registerGetter(L, "myInterior", Building_get_myInterior);
    registerGetter(L, "buildingsManager", Building_get_buildingsManager);
    registerGetter(L, "rootNode", Building_get_rootNode);
    registerGetter(L, "soundEmitter", Building_get_soundEmitter);
    registerGetter(L, "hasAudio", Building_get_hasAudio);
    registerGetter(L, "interiorGround", Building_get_interiorGround);
    registerGetter(L, "exteriorGround", Building_get_exteriorGround);
    registerGetter(L, "physical", Building_get_physical);
    registerGetter(L, "entitiesToLoad", Building_get_entitiesToLoad);
    registerGetter(L, "entitiesLoaded", Building_get_entitiesLoaded);
    registerGetter(L, "isFurnitureOf", Building_get_isFurnitureOf);
    registerGetter(L, "isOutsideFurniture", Building_get_isOutsideFurniture);
    registerGetter(L, "isNestItem", Building_get_isNestItem);
    registerGetter(L, "baseMaterial", Building_get_baseMaterial);
    registerGetter(L, "effectsVisible", Building_get_effectsVisible);
    registerGetter(L, "effectsActive", Building_get_effectsActive);
    registerGetter(L, "lightsVisible", Building_get_lightsVisible);
    registerGetter(L, "positionMarker", Building_get_positionMarker);
    registerGetter(L, "heightAboveGround", Building_get_heightAboveGround);
    registerGetter(L, "isRedDebugTextureMode", Building_get_isRedDebugTextureMode);
    registerGetter(L, "materialName", Building_get_materialName);
    registerGetter(L, "triggerVolume", Building_get_triggerVolume);
    lua_setfield(L, -2, "__getters"); // Bind to metatable

    lua_newtable(L); // Create __setters table
    registerSetter(L, "isFoliage", Building_set_isFoliage);
    registerSetter(L, "hasTerrainInside", Building_set_hasTerrainInside);
    registerSetter(L, "isCavernous", Building_set_isCavernous);
    registerSetter(L, "enforceCeiling", Building_set_enforceCeiling);
    registerSetter(L, "designation", Building_set_designation);
    registerSetter(L, "publicDaytime", Building_set_publicDaytime);
    registerSetter(L, "residentSquad", Building_set_residentSquad);
    registerSetter(L, "residentSquadTemplate", Building_set_residentSquadTemplate);
    registerSetter(L, "isAnInteriorObject", Building_set_isAnInteriorObject);
    registerSetter(L, "instanceID", Building_set_instanceID);
    registerSetter(L, "layoutInstanceID", Building_set_layoutInstanceID);
    registerSetter(L, "specialFunction", Building_set_specialFunction);
    registerSetter(L, "_buildState", Building_set__buildState);
    registerSetter(L, "classType", Building_set_classType);
    registerSetter(L, "updateNavmesh", Building_set_updateNavmesh);
    registerSetter(L, "visible", Building_set_visible);
    registerSetter(L, "doors", Building_set_doors);
    registerSetter(L, "interiorVisibility", Building_set_interiorVisibility);
    registerSetter(L, "justBeenUpgradedFlag", Building_set_justBeenUpgradedFlag);
    registerSetter(L, "imADoor", Building_set_imADoor);
    registerSetter(L, "destroyed", Building_set_destroyed);
    registerSetter(L, "productionMult", Building_set_productionMult);
    registerSetter(L, "productionMult_baseData", Building_set_productionMult_baseData);
    registerSetter(L, "hasMovingParts", Building_set_hasMovingParts);
    registerSetter(L, "saveVersion", Building_set_saveVersion);
    registerSetter(L, "_town", Building_set__town);
    registerSetter(L, "buildingsManager", Building_set_buildingsManager);
    registerSetter(L, "hasAudio", Building_set_hasAudio);
    registerSetter(L, "interiorGround", Building_set_interiorGround);
    registerSetter(L, "exteriorGround", Building_set_exteriorGround);
    registerSetter(L, "entitiesToLoad", Building_set_entitiesToLoad);
    registerSetter(L, "entitiesLoaded", Building_set_entitiesLoaded);
    registerSetter(L, "isOutsideFurniture", Building_set_isOutsideFurniture);
    registerSetter(L, "isNestItem", Building_set_isNestItem);
    registerSetter(L, "baseMaterial", Building_set_baseMaterial);
    registerSetter(L, "effectsVisible", Building_set_effectsVisible);
    registerSetter(L, "effectsActive", Building_set_effectsActive);
    registerSetter(L, "lightsVisible", Building_set_lightsVisible);
    registerSetter(L, "positionMarker", Building_set_positionMarker);
    registerSetter(L, "heightAboveGround", Building_set_heightAboveGround);
    registerSetter(L, "isRedDebugTextureMode", Building_set_isRedDebugTextureMode);
    registerSetter(L, "materialName", Building_set_materialName);

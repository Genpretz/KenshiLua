...
void DoorStuffBinding::registerBinding(lua_State* L)
{
    ...
    registerGetter(L, "isSetupComplete", DoorStuff_get_isSetupComplete);
    registerGetter(L, "parent", DoorStuff_get_parent);
    registerGetter(L, "doorLock", DoorStuff_get_doorLock);
    registerGetter(L, "gateCode", DoorStuff_get_gateCode);
    registerGetter(L, "doorOpenAmount", DoorStuff_get_doorOpenAmount);
    registerGetter(L, "state", DoorStuff_get_state);
    registerGetter(L, "wantsToLock", DoorStuff_get_wantsToLock);
    registerGetter(L, "doorSpeed", DoorStuff_get_doorSpeed);
    registerGetter(L, "doorDistance", DoorStuff_get_doorDistance);
    registerGetter(L, "doorMoveAxis", DoorStuff_get_doorMoveAxis);
    registerGetter(L, "doorComesOut", DoorStuff_get_doorComesOut);
    registerGetter(L, "nodeClosedPosition", DoorStuff_get_nodeClosedPosition);
    registerGetter(L, "actorClosedPosition", DoorStuff_get_actorClosedPosition);
    registerGetter(L, "doorClosedPosition", DoorStuff_get_doorClosedPosition);
    registerGetter(L, "doorClosedPositionOut", DoorStuff_get_doorClosedPositionOut);
    registerGetter(L, "doorClosedPositionIn", DoorStuff_get_doorClosedPositionIn);
    registerGetter(L, "axisH", DoorStuff_get_axisH);
    registerGetter(L, "axisF", DoorStuff_get_axisF);
    registerGetter(L, "_isBroken", DoorStuff_get__isBroken);
    lua_setfield(L, -2, "__getters"); // Bind to metatable

    lua_newtable(L); // Create __setters table
    registerSetter(L, "isSetupComplete", DoorStuff_set_isSetupComplete);
    registerSetter(L, "parent", DoorStuff_set_parent);
    registerSetter(L, "doorLock", DoorStuff_set_doorLock);
    registerSetter(L, "gateCode", DoorStuff_set_gateCode);
    registerSetter(L, "doorOpenAmount", DoorStuff_set_doorOpenAmount);
    registerSetter(L, "state", DoorStuff_set_state);
    registerSetter(L, "wantsToLock", DoorStuff_set_wantsToLock);
    registerSetter(L, "doorSpeed", DoorStuff_set_doorSpeed);
    registerSetter(L, "doorDistance", DoorStuff_set_doorDistance);
    registerSetter(L, "doorMoveAxis", DoorStuff_set_doorMoveAxis);
    registerSetter(L, "doorComesOut", DoorStuff_set_doorComesOut);
    registerSetter(L, "nodeClosedPosition", DoorStuff_set_nodeClosedPosition);
    registerSetter(L, "actorClosedPosition", DoorStuff_set_actorClosedPosition);
    registerSetter(L, "doorClosedPosition", DoorStuff_set_doorClosedPosition);
    registerSetter(L, "doorClosedPositionOut", DoorStuff_set_doorClosedPositionOut);
    registerSetter(L, "doorClosedPositionIn", DoorStuff_set_doorClosedPositionIn);
    registerSetter(L, "axisH", DoorStuff_set_axisH);
    registerSetter(L, "axisF", DoorStuff_set_axisF);
    registerSetter(L, "_isBroken", DoorStuff_set__isBroken);

...
Total Enum Registration Functions: **109** (2247 bound values/aliases) across **42** SDK header files.
...
C++ Binding Function: `registerNxControllerAction(lua_State* L)`

**Original Enumerators:**

| Lua Key / Name | C++ Value / Enumerator |
| :--- | :--- |
| `NX_ACTION_NONE` | `NxControllerAction::NX_ACTION_NONE` |
| `NX_ACTION_PUSH` | `NxControllerAction::NX_ACTION_PUSH` |

**Aliases:**

| Lua Key / Name | C++ Value / Enumerator |
| :--- | :--- |
| `NONE` | `NxControllerAction::NX_ACTION_NONE` |
| `PUSH` | `NxControllerAction::NX_ACTION_PUSH` |
...
C++ Binding Function: `registerItemType(lua_State* L)`
...
C++ Binding Function: `registerSaveFileSystemMessageType(lua_State* L)`

| Lua Key / Name | C++ Value / Enumerator |
| :--- | :--- |
| `MSG_COPY` | `SaveFileSystem::MSG_COPY` |
| `MSG_COPY_REPLACE` | `SaveFileSystem::MSG_COPY_REPLACE` |
| `MSG_DELETE` | `SaveFileSystem::MSG_DELETE` |

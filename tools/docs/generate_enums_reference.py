...
def generate_markdown(sections):
    ...
    md.append("")
    md.append("This document is automatically generated by `tools/docs/generate_enums_reference.py` based on `src/Bindings/EnumBinding.cpp`.")
    md.append("")
    md.append("## Overview")
    md.append("")

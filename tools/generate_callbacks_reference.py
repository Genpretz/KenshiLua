...
def generate_markdown(callbacks, registry_map):
    ...
    output.append("")
    output.append("This document is automatically generated by `tools/generate_callbacks_reference.py` based on `src/Callbacks.h` and `src/Hooks/Hooks_Registry.cpp`.")
    output.append("")

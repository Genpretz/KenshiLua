...
-- KenshiLua.createWindow(skin, x, y, width, height, name, parentOrLayer)
-- We use layer "Window" if there's no parent.
-- Kenshi skins usually prefix with "Kenshi_"
local mainWindow = KenshiLua.createWindow("Kenshi_WindowCX", 100, 100, 400, 400, "ExampleWindow", "Window")
...
local myButton = KenshiLua.createButton("Kenshi_Button1", 20, 40, 150, 30, "ExampleButton", mainWindow)
...
local editBox = KenshiLua.createEditBox("Kenshi_EditBox", 20, 90, 200, 30, "ExampleEditBox", mainWindow)
...
-- 4. Create a ListBox
local listBox = KenshiLua.createListBox("Kenshi_ListBox", 20, 140, 200, 150, "ExampleListBox", mainWindow)
...
local label = KenshiLua.createTextBox("Kenshi_TextboxPaintedText", 20, 310, 300, 20, "ExampleLabel", mainWindow)
...
local closeBtn = KenshiLua.createButton("Kenshi_Button1", 250, 310, 100, 30, "CloseButton", mainWindow)
